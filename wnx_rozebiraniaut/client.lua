...
local function CreateChopLocation(car)
        ...
        local options = {
            {
                ...
                label = 'Odebrat kapotu',
                bones = {'bonnet'},
                onSelect = function()
                    local boneId = GetEntityBoneIndexByName(car, 'bonnet')
                    local doorIndex = 4
                    local option = 'ox:option1'
                    TriggerEvent('wnx_chopshop:removeDoor', car, doorIndex, option)
                end 
            },{
                -- Front Driver Door
                name = 'ox:option2',
                icon = 'fa-solid fa-car',
                label = 'Odebrat Přední dveře řidiče',
                bones = {'door_dside_f'},
                onSelect = function()
                ...
                name = 'ox:option3',
                icon = 'fa-solid fa-car',
                label = 'Odebrat Přední dveře spolujezdce',
                bones = {'door_pside_f'},
                onSelect = function()
                ...
                name = 'ox:option4',
                icon = 'fa-solid fa-car',
                label = 'Odebrat Zadní dveře řidiče',
                bones = {'door_dside_r'},
                onSelect = function()
                ...
                name = 'ox:option5',
                icon = 'fa-solid fa-car',
                label = 'odebrat Zadní spolujezdec dveře',
                bones = {'door_pside_r'},
                onSelect = function()
                ...
                name = 'ox:option7',
                icon = 'fa-solid fa-car',
                label = 'Odebrat Přední levá pneumatika',
                bones = {'wheel_lf'},
                onSelect = function()
                    local boneId = GetEntityBoneIndexByName(car, 'wheel_lf')
                    local wheelIndex = 0
                    local option = 'ox:option7'
                    TriggerEvent('wnx_chopshop:removeWheel', car, wheelIndex, option)
                end 
            },{
                -- Front Right Tire
                name = 'ox:option8',
                icon = 'fa-solid fa-car',
                label = 'Odebrat Front Right Tire',
                bones = {'wheel_rf'},
                onSelect = function()
                ...
                name = 'ox:option9',
                icon = 'fa-solid fa-car',
                label = 'Odebrat zadní levá pneumatika',
                bones = {'wheel_lr'},
                onSelect = function()
                ...
                name = 'ox:option10',
                icon = 'fa-solid fa-car',
                label = 'Odebrat Zadní pravá pneumatika',
                bones = {'wheel_rr'},
                onSelect = function()
                ...
                onSelect = function()
                    ...
                    TriggerEvent('wnx_chopshop:chassisRemove', car)
                end
            }
        }

        Target:addLocalEntity(car, options)
        TriggerEvent('wnx_chopshop:removeZone')
    ...
    RegisterNetEvent('wnx_chopshop:removeZone', function(boneId)
        chopBox:remove()
    end)
end 

--! Remove car parts + animations
RegisterNetEvent('wnx_chopshop:removeDoor', function(car, doorIndex, option)
    ...
    if success then 
        ...
        then
            TriggerServerEvent('wnx_chopshop:chopDoorReward', car, doorIndex, option)
        else 
...
RegisterNetEvent('wnx_chopshop:doorFinalRemove', function(car, doorIndex, option)
    Target:disableTargeting(false)
...
RegisterNetEvent('wnx_chopshop:removeWheel', function(car, wheelIndex, option)
    local success = lib.skillCheck(Config.Chop[1].SkillCheckDifficulty, Config.Chop[1].SkillCheckKeys)
    if success then 
        Target:disableTargeting(true)
        local cfg = Config.Chop[1]
        if lib.progressCircle({
            ...
            TriggerServerEvent('wnx_chopshop:chopWheelReward', car, wheelIndex, option)
        else 
            Target:disableTargeting(false)
        end
    else 
...
RegisterNetEvent('wnx_chopshop:wheelFinalRemove', function(car, wheelIndex, option)
    Target:disableTargeting(false)
    Target:removeLocalEntity(car, option)
...
RegisterNetEvent('wnx_chopshop:chassisRemove', function(car, option)
    local success = lib.skillCheck(Config.Chop[1].SkillCheckDifficulty, Config.Chop[1].SkillCheckKeys)
    if success then 
        Target:disableTargeting(true)
        local cfg = Config.Chop[1]
        ...
        then
            TriggerServerEvent('wnx_chopshop:chopChassisReward', car)
        else 
            Target:disableTargeting(false)
        end
    else 
...
RegisterNetEvent('wnx_chopshop:chassisFinalRemove', function(car)
    Target:disableTargeting(false)
    DeleteEntity(car)
...
RegisterNetEvent('wnx_chopshop:InvFullTargetReset', function()
    Target:disableTargeting(false)
end)
...
RegisterNetEvent("wnx_chopshop:ExchangeCircle", function(input)
    if lib.progressCircle({
    ...
    then 
        TriggerServerEvent("wnx_chopshop:ExchangeReward", input)
    else 
        return
    end
end)
